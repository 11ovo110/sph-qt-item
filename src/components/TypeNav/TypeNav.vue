        ...
        <transition name="sort">
            <div class="sort" v-show="flag">
                <div class="all-sort-list2">
                    <div class="item" v-for="(t1, index) in typeArr" :key="t1.categoryId" @click="goSearch">
  ...
  methods: {
    ...
    goSearch(e) {
        ...
        if(categoryname) {
            ...
            if(category1id) str.query.category1Id = category1id;
            else if(category2id) str.query.category2Id = category2id;
            else str.query.category3Id = category3id;
            str.query.categoryName = categoryname;
