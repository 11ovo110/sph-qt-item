            ...
            <div class="priceArea">
              ...
              <div class="priceArea2">
                ...
                <div class="fixWidth">
                  ...
                  <em class="t-gray">{{skuInfo.createTime + skuInfo.skuDesc}}</em>
                </div>
              </div>
            </div>
            <div class="support">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="sale in SaleAttr" :key="sale.id">
                ...
                <dd changepirce="0" @click="valueHandler(sale.spuSaleAttrValueList, value)" :class="{'active': value.isChecked == 1}" v-for="value in sale.spuSaleAttrValueList" :key="value.id">{{value.saleAttrValueName}}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
                ...
                <a @click="skuNum > 1 && skuNum--" class="mins">-</a>
              </div>
              <div class="add">
  ...
  export default {
    ...
    methods: {
     async addCar() {
      ...
      try {
        await this.$store.dispatch('addGood', { skuId, skuNum });
        sessionStorage.setItem('good', JSON.stringify(this.skuInfo));
        this.$router.push({
          name: 'success',
          params: {
            skuNum: this.skuNum
