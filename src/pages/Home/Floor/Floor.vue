        ...
        <div class="title clearfix">
            ...
            <div class="fr">
                <ul class="nav-tabs clearfix">
                    <li :class="{'active': current==index}" @mouseenter="current=index" v-for="(nav, index) in floor.navList" :key="index">
                ...
                <div class="floor-1">
                    ...
                    <div class="floorBanner">
                       <Swiper :options="options" ref="swiper">
                        <SwiperSlide v-for="carousel in floor.carouselList" :key="carousel.id">
